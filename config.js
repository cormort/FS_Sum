...
export const CASH_FLOW_ACCOUNT_ORDER = [
    '營業活動之現金流量', '繼續營業單位稅前淨利（淨損）', '停業單位稅前淨利（淨損）', '稅前淨利（淨損）',
    '利息股利之調整', '未計利息股利之稅前淨利（淨損）', '調整項目', '未計利息股利之現金流入（流出）',
    '收取利息', '收取股利', '支付利息', '發放現金股利', '退還（支付）所得稅', '營業活動之淨現金流入（流出）',
    '投資活動之現金流量', '流動金融資產淨減（淨增）', '減少投資', '減少投資子公司', '減少基金及長期應收款',
    '減少不動產、廠房及設備', '減少使用權資產', '減少投資性不動產', '減少生物資產', '無形資產及其他資產淨減（淨增）',
    '其他投資活動之現金流入', '增加投資', '增加投資子公司', '增加基金及長期應收款', '增加不動產、廠房及設備',
    '增加使用權資產', '增加投資性不動產', '增加生物資產', '其他投資活動之現金流出',
    '收取利息 (投資活動)', '收取股利 (投資活動)',
    '投資活動之淨現金流入（流出）',
    '籌資活動之現金流量', '短期債務淨增（淨減）', '流動金融負債淨增（淨減）', '金融債券淨增（淨減）',
    '央行及同業融資淨增（淨減）', '增加長期債務', '增加非流動金融負債', '其他負債淨增（淨減）', '增加資本、公積及填補虧損',
    '其他籌資活動之現金流入', '減少長期債務', '減少非流動金融負債', '減少資本', '其他籌資活動之現金流出',
    '支付利息 (籌資活動)',
    '籌資活動之淨現金流入（流出）',
    '匯率影響數', '現金及約當現金之淨增（淨減）', '期初現金及約當現金', '期末現金及約當現金'
];
